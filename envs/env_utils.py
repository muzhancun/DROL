...
def make_env_and_datasets(env_name, frame_stack=None, action_clip_eps=1e-5, chunk_size=None):
    ...
    if 'singletask' in env_name:
        ...
        train_dataset = Dataset.create(**train_dataset, chunk_size=chunk_size)
        val_dataset = Dataset.create(**val_dataset, chunk_size=chunk_size)
        ...
        dataset = d4rl_utils.get_dataset(env, env_name, chunk_size=chunk_size if chunk_size is not None else 5)
